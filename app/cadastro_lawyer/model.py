...
from app.association import association_adm_lawyer
...
class Lawyer(BaseModel):
    ...
    administrador = db.relationship('Administrador', secondary=association_adm_lawyer, backref='lawyer_adm')
    patient = db.relationship(Patient, backref='lawyer_patient')
