...
from app.cadastro_administrador.controllers import (AdministradorLista, AdministradorCreate, AdministradorDetails, AdministradorConfirm, EmailPassword, ResetPassword, RegisterConfirm, RegisterAcceptLawyer, RegisterAcceptGestor, RegisterAcceptOutros, RegisterAcceptMedico, RegisterAcceptResponsavel, ShowMedico, ShowMedicoPatient) 
...
administrador_api.add_url_rule(
    '/register-accept-lawyer/<int:administrador_id>/<int:id>', view_func=RegisterAcceptLawyer.as_view('register_accept_lawyer'), methods=['PATCH']
)
...
administrador_api.add_url_rule(
    '/show/medico/patient/<int:medico_id>', view_func=ShowMedicoPatient.as_view('show_medico_patient'), methods=['GET']
)