...
from app.association import association_adm_patient, association_gestor_patient
...
class Patient(BaseModel):
    ...
    administrador = db.relationship('Administrador', secondary=association_adm_patient, backref='patient_adm')
    gestor = db.relationship('Gestor', secondary=association_gestor_patient, backref='patient_gestor')
    lawyer_id = db.Column(db.Integer, db.ForeignKey('lawyer.id'))
    agendamento = db.relationship('Agendamento', backref='patient')
