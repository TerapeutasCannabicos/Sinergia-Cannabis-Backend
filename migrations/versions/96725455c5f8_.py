...
Revision ID: 96725455c5f8
Revises: 
Create Date: 2021-08-03 22:51:49.734931
...
def upgrade():
    ...
    op.create_table('association_adm_advogado',
    ...
    sa.ForeignKeyConstraint(['advogado_id'], ['advogado.id'], )
    )
    ...
    op.create_table('association_adm_paciente',
    sa.Column('administrador_id', sa.Integer(), nullable=True),
    sa.Column('paciente_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['administrador_id'], ['administrador.id'], ),
    sa.ForeignKeyConstraint(['paciente_id'], ['paciente.id'], )
    )
    op.create_table('ssociation_gestor_paciente',
    sa.Column('gestor_id', sa.Integer(), nullable=True),
    sa.Column('paciente_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['gestor_id'], ['gestor.id'], ),
    sa.ForeignKeyConstraint(['paciente_id'], ['paciente.id'], )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('ssociation_gestor_paciente')
    op.drop_table('association_adm_paciente')
    ...
    op.drop_table('association_adm_advogado')
